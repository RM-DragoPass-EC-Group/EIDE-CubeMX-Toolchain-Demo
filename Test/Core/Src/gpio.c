...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(Mag_RSTN_GPIO_Port, Mag_RSTN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Accel_SPI1_CS_GPIO_Port, Accel_SPI1_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Gyro_SPI1_CS_GPIO_Port, Gyro_SPI1_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PB8 PB5 PB9 PB6
                           PB2 PB12 PB13 PB1
                           PB10 PB11 PB14 PB15 */
  GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_5|GPIO_PIN_9|GPIO_PIN_6
  ...
  /*Configure GPIO pin : Mag_RSTN_Pin */
  GPIO_InitStruct.Pin = Mag_RSTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Mag_RSTN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : Accel_SPI1_CS_Pin */
  GPIO_InitStruct.Pin = Accel_SPI1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Accel_SPI1_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Accel_DRDY_Pin Gyro_DRDY_Pin */
  GPIO_InitStruct.Pin = Accel_DRDY_Pin|Gyro_DRDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : Gyro_SPI1_CS_Pin */
  GPIO_InitStruct.Pin = Gyro_SPI1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Gyro_SPI1_CS_GPIO_Port, &GPIO_InitStruct);
